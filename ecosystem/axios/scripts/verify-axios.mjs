...
const axiosManifest = JSON.parse(
	await readFile(resolve('node_modules/axios/package.json'), 'utf8'),
);
assert.equal(axiosManifest.version, '1.20.0');
...
const viruneResult = viruneLines.find(line => line.startsWith('ecosystem:axios:'));
